...
class Search:
    """
    """
    def __init__(self, feed = Constants.VideoRoom.FeedTypes.Optimal, download: bool = False,
                pitch = None, params: list = Constants.VideoRoom.DefaultParameters):
