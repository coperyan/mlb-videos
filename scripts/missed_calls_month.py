...
bad_pitch_ids = ["662381|1|4", "663150|60|3", "", ""]
...
# Limit to top 30..
pitches.df = pitches.df[(pitches.df["total_miss_rank"] <= 30)]
pitches.refresh_index()
...
yt_client = Video(
    ...
    desc=(
        f"The video I uploaded for April did really well, so I ran the numbers again for May..\n."
